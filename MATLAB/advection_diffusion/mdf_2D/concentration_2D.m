function [concentration_per_volume, mp] = concentration_2D(data_inputs, dimension_number_of_points)
    ...
    concentration_per_volume = mdf_explicit_2D(concentration_per_volume, mp, d.is_stochastic);
end
...
\begin{dedicatoria}
   ...
   \centering
   \noindent
   \textit{ Aos 'Químigos', professores e amigos que conviveram comigo nos últimos anos,\\
   agradeço por todos os momentos de aprendizagem em conjunto, e a eles dedico o meu projeto.} \vspace*{\fill}
\end{dedicatoria}
% ---
